 ...
 <li>
    ...
    <div class="content-wra">
        <div class="content-wrapper">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Update Category Information</h4>
   ...
   Category
    ...
    <div class="panel-body">
        ...
        <form  method="post" action="updatecategory-process.jsp">
            <%
            try{
            stat=conn.createStatement();
            String u=request.getParameter("u");
            int num=Integer.parseInt(u);
            String data="select * from category where id='"+num+"'";
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="category1" value="<%=res.getString("categoryname") %>"/>
                </div>
                <%
            }}catch(Exception e){ 
