...
<!-- MENU SECTION END-->
    ...
    <form >
    <label>Search:<input type="search" class="form-control input-sm" aria-controls="dataTables-example" name="author" required></label>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        try{ 
                                            ...
                                            PreparedStatement ps = conn.prepareStatement("select * from author where author=?");
