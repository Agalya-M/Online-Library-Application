...
<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
    ...
    <div class="content-wra">
        <div class="content-wrapper">
            ...
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Update Author Information</h4>
    ...
    <div class="panel-body">
        ...
        <form  method="post" action="updateauthor-process.jsp">
            <%
            try{
            stat=conn.createStatement();
            String u=request.getParameter("u");
            int num=Integer.parseInt(u);
            String data="select * from author where id='"+num+"'";
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="author1" value="<%=res.getString("author") %>"/>
                </div>
                <%
            }}catch(Exception e){ 
